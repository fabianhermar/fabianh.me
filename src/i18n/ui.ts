...
export const ui = {
	...
	de: {
		...
		'footer.blog': 'Blog',
		'footer.small':
			'Entwickelt mit viel ❤ unter Verwendung von <a class="font-accent font-bold underline text-[#FF5D01]" href="https://astro.build" target="_blank">Astro</a> und <a class="font-accent font-bold underline text-[#00D8FF]" href="https://react.dev" target="_blank">React</a>. Bereitgestellt auf  <a class="font-accent font-bold underline text-black" href="https://vercel.com" target="_blank">Vercel</a> und verwaltet von <a class="font-accent font-bold underline text-[#F48120]" href="https://cloudflare.com" target="_blank">CloudFlare</a>.',
	},
} as const
